local c = require "onegruv.palette"
...
if vim.g.onegruv_italic_keywords then
  italic_keywords = true
end

if vim.g.onegruv_italic_functions then
  italic_functions = true
end

if vim.g.onegruv_italic_comments then
  italic_comments = true
end

if vim.g.onegruv_italic_loops then
  italic_loops = true
end

if vim.g.onegruv_italic_conditionals then
...
theme.set_highlights = function()
  ...
  hl(0, "Type", { fg = c.green, bg = "NONE" })
  hl(0, "Function", { fg = c.yellow, bg = "NONE", italic = italic_functions })
  hl(0, "Keyword", { fg = c.purple, bg = "NONE", italic = italic_keywords })
  hl(0, "Conditional", { fg = c.blue, bg = "NONE", italic = italic_conditionals })
  ...
  hl(0, "TSTypeBuiltin", { fg = c.yellow, bg = "NONE" })
  hl(0, "TSAnnotation", { fg = c.yellow, bg = "NONE" })
  hl(0, "TSNamespace", { fg = c.green, bg = "NONE" })
  ...
  hl(0, "TSAttribute", { fg = c.green, bg = "NONE" })
